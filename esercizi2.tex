...
Per dimostrare la relazione tra il numero di set indipendenti di un cammino, basta verificare cosa accade all'aggiungere di un vertice ad un cammino $Pn$. Ad esempio dato il seguente cammino:
\begin{center}
\begin{tikzpicture}
...
Cosa accadrebbe se aggiungessimo un nodo d? Avremmo il seguente path:
\begin{center}
\begin{tikzpicture}
