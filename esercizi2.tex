...
\problemAnswer{
Prima di scrivere l'algoritmo, possiamo fare una considerazione: se consideriamo il grafo complementare del grafo in input, come nell'esempio seguente 
\begin{center}
\begin{tikzpicture}
...
Questa proprietà del grafo complementare vale per qualsiasi tipo di grafo in input, che possiamo sfruttare per il nostro algoritmo.
Per la rappresentazione del grafo in questo caso può essere utile utilizzare le \emph{liste di adiacenza}. Cioè ad ognuno dei nodi viene associata una lista che contiene tutti i nodi ad esso adiacenti, come nell'esempio seguente (riferito all'ultimo grafo)
\begin{center}
\begin{tikzpicture}
