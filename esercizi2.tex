...
\problemAnswer{
Così come lo abbiamo verificato per i set indipendeti dei cammini $P_{n,k}$, possiamo fare la medesima considerazione per i cicli $C_{n,k}$. Considerando ad esempio il ciclo seguente composto da 6 vertici (e il suo grafo complementare tratteggiato)
\begin{center}
\begin{tikzpicture}[thick,scale=0.6, every node/.style={scale=0.6}]
