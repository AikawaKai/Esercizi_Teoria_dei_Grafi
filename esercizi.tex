...
|P(S)| = 2^{|S|}
\]
la cardinalità dell'insieme potenza dell'insieme potenza dell'insieme vuoto è
\[
2^{0} = 1
\]
...
\]
Se raggruppiamo i sottoinsiemi a seconda del numero di elementi contengono otteniamo:
\[
|\{a,b,c\}|, |\{a,b\}, \{a,c\}, \{b,c\}|, |\{a\}, \{b\}|, |\{c\}|, |0|
\]
