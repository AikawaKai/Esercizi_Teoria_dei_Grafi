...
\problemAnswer{
Sapendo che ogni elemnto di una riga del triangolo di tartaglia è calcolabile come il binomiale
\[
{n \choose k}
\]
...
\end{tabular}
\end{center}
partendo dalla seconda riga e sommando gli elemnti di posto pari e di posto dispari otteniamo le coppie
\begin{gather}
(1, 1)  \quad n = 1\\
(2, 2)  \quad n = 2\\
(4, 4)  \quad n = 3\\
...
\problemAnswer{
Ricordando che $P(n,x)$ non rappresenta altro che il numero in quanti modi possiamo ottenere il numero n sommando x numeri naturali, prendiamo ad esempio $P(5,2)$ che è uguale a
\[
P(5,2) = 2
\]
E cioè $2+3$ e $1+4$.
